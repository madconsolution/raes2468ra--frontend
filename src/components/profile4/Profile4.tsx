...
import { IoHomeOutline,IoCall  } from "react-icons/io5";
...
const Profile4 = () => {
  return (
    <div>
      <div className="min-h-screen bg-[#F9F9F9] w-full max-w-md mx-auto flex flex-col relative">
        {/* Scrollable Content */}
            ...
            <Tabs defaultValue="Details" className="w-full">
              ...
              <div className="w-full mx-auto space-y-4 mt-4">
                <div className="flex items-center justify-between p-4 bg-white rounded-xl shadow-md">
                  ...
                  <span className="text-gray-600">2347586966969</span>
                </div>
                ...
                <div className="flex items-center justify-between p-4 bg-white rounded-xl shadow-md">
                  ...
                  <span className="text-gray-600">mywebsite.com</span>
                </div>
                ...
                <div className="flex items-center justify-between p-4 bg-white rounded-xl shadow-md">
                  ...
                  <span className="text-gray-600">myemail.com</span>
                </div>
              ...
              {/* Conditional content for other tabs */}
        ...
        {/* extra absolute part  */}
        <div className="absolute rounded-2xl space-y-6  top-32 w-full h-[540px] bg-white rounded-t-3xl shadow-lg z-20 px-8 py-10 pt-20">
          <div className="space-y-1">
            <h2 className="text-xl font-bold">Web Development</h2>
            <div className="flex gap-3 items-center">
              <div className="w-13 h-13 rounded-full bg-gray-400"></div>
              <div className="space-y-1">
                <h2 className="font-bold">Kyle Gee Services</h2>
                <h6 className="text-sm text-gray-500">
                  UI/UX Design/Team Lead
                </h6>
              </div>
              <FaArrowRight className="w-8 h-8 text-gray-500 ml-auto" />
            </div>
          </div>
          ...
          <form className="space-y-10 mt-14">
            <div>
              ...
              <div className="flex items-center border rounded-lg px-3 py-2 space-x-2">
                <CiMail className="w-10 h-10 text-gray-400" />
                <input
                  type="email"
                  placeholder="Hello@Zachry.com"
                  className="w-full text-xl text-gray-700 bg-transparent focus:outline-none"
                />
              </div>
            </div>
            <div>
            <label className="block text-xl font-medium text-gray-700 mb-2">
              ...
              <div className="flex items-center border rounded-lg px-3 py-2 space-x-2">
                <IoCall className="w-10 h-10 text-gray-400" />
                <input
                  type="email"
            ...
            <Button className="w-full h-10 bg-[#f3766b] text-white rounded-full mb-4 text-base">
              EXCHANGE
            </Button>
          </form>
        </div>
